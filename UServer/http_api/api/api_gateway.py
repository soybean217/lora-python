...
from http_api.api import api, root
from http_api.api.decorators import gateway_belong_to_user
...
def gateways(user):
    if request.method == 'GET':
        ...
        print('gateway', start, mid - start, end - start)
        return Response(status=200, response=json.dumps(gateways_list))
