...
from .validators import freq_plan_validate, eui_validator, appkey_validator
...
class AddAppForm(Form):
    ...
    freq_plan = StringField("Frequency Plan", validators=[validators.DataRequired(), freq_plan_validate])
